...
import { Bell, Check, CheckCheck, Trash2, Eye, Building2, CheckCircle2, XCircle, Info } from "lucide-react";
...
export default function AdminNotificationsPage() {
  ...
  const getIconBgClass = (type, message) => {
    ...
    switch (type) {
      case "church_application_created":
        return "bg-blue-50";
      case "church_application_approved":
        return "bg-green-50";
      case "church_application_rejected":
        return "bg-red-50";
      case "church_application_status_changed":
  ...
  const isAdmin = user?.profile?.system_role?.role_name === "Admin";
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600">
                  {filter === "all" && "You'll see notifications here when there are church application updates."}
                </p>
              </div>
            ) : (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {/* View Church Application Button */}
                        {(notification.type === "church_application_created" || 
                          notification.type === "church_application_approved" || 
                          notification.type === "church_application_rejected" ||
                          notification.type === "church_application_status_changed") &&
                          notification.data?.application_id && (
                            <div className="mt-3">
                              <Link
                                href={`/application?applicationId=${notification.data.application_id}`}
